...
const useColorCycle = () => {
    const shadows = ['shadow-[0px_0px_15px_10px_#393e79]','shadow-[0px_0px_15px_10px_#065f46]','shadow-[0px_0px_15px_10px_#1e293b]']
    const bgs = ['bg-[#1f2241]','bg-[#022c22]', 'bg-[#0b0c10]']
    const colors = ['text-[#FF6D88]', 'text-[#ffbf34]', 'text-[#67ffcc]'];
    const ringColors = ['ring-[#FF6D88]', 'ring-[#ffbf34]', 'ring-[#67ffcc]']
